...
To make your site available from `primer.style/my-site`, check out "[Adding a primer.style path alias](/deployment#adding-a-primer.style-path-alias)" in the [Deployment](/deployment) guide.
