...
When you create a Markdown file (`.md` or `.mdx`) in `src/pages/`, you can include a set of key-value pairs to provide additional information about that page. This information is called frontmatter and is set between triple dashes starting on the first line of the file:
