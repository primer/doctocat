...
When you create a Markdown file (`.md` or `.mdx`) in `src/pages/`, you can include a set of key-value pairs that provide additional information about that page. This information is called frontmatter and is set between triple dashes starting on the first line of the file:
...
Doctocat recognizes some specific frontmatter key-value pairs described below.
...
You can add a status label to any page by setting a `status` key in the frontmatter:
