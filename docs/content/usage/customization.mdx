...
```yml title='src/@primer/gatsby-theme-doctocat/nav.yml'
- title: Example
  url: /example
  children:
    - title: Example 2
...
```jsx title="src/@primer/gatsby-theme-doctocat/components/hero.js"
...
```js title="src/@primer/gatsby-theme-doctocat/mdx-components.js"
