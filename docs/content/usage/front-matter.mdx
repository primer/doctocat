...
import {StatusLabel, ExternalLink} from '@primer/gatsby-theme-doctocat'
...
<BorderBox p={4} mb={3}>
  <ExternalLink href="#">View source</ExternalLink>
</BorderBox>
...
<BorderBox p={4} mb={3}>
  <ExternalLink href="#">View storybook</ExternalLink>
</BorderBox>
