...
## Hide "Edit this page on GitHub" link

If the `hideEditLink` front matter variable is set to true, Doctocat will remove the edit this page link at the bottom of the page, like this:
