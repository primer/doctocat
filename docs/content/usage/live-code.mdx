...
<div>
  <p>This paragraph element should be higlighted.</p>
  <p>This paragraph element should not be higlighted.</p>
</div>
```
````
...
<div>
  ...
  <p>This text should be red. All other text on the page should be unaffected.</p>
</div>
```
