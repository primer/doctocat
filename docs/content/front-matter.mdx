...
When you create a Markdown file (`.md` or `.mdx`) in `content/`, you can define variables to provide additional information about that page. This information is called front matter and is set between triple dashes starting on the first line of the file:
