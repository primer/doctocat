...
After you've customized the content of your site, you're ready to deploy. There are many ways to deploy your site, but we currently use [Vercel](https://vercel.com) for most of our sites, and have found it to be an easy way to get sites up and running quickly. The easiest way to deploy to Vercel is with their GitHub integration. You'll need to create a Vercel account, connect your GitHub account, then enable the integration for your repository. Check out the [Vercel for GitHub docs](https://vercel.com/github) for more detailed instructions.
