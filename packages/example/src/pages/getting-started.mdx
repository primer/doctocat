...
To make your site available from `primer.style/my-site`, check out the "[Adding a primer.style path alias](/guides/deploying#adding-a-primer.style-path-alias)" section of the [Deploying](/guides/deploying) guide.
